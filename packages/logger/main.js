...
*/
module.exports=function(source,pid,priority,facility){

	if((typeof(root.config.logger.debug)=='boolean')&&(root.config.logger.debug)){
		console.log("starting logger constructor.");
		console.log("----------------------------");
