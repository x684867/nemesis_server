...
describe('Hoek', function () {
    ...
    describe('#loadDirpackages', function () {

        it('should load packages from directory', function (done) {

            var target = {};
            Hoek.loadDirpackages(__dirname + '/packages', ['test2'], target);
        ...
        it('should list packages from directory into function', function (done) {

            var target = {};
            Hoek.loadDirpackages(__dirname + '/packages', ['test2'], function (path, name, capName) {
