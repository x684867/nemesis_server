...
which is beyond the scope of this package. Typically, the shared credentials are established via an initial
...
**Hawk** utilized the [**SNTP**](https://github.com/hueniverse/sntp) package for time sync management. By default, the local
...
Implementers are strongly encouraged to assess how this package addresses their security requirements. This section includes
...
At if version 0.10.0, **Hawk** is feature-complete. However, until this package reaches version 1.0.0 it is considered experimental
and is likely to change. This also means your feedback and contribution are very welcome. Feel free to open issues with questions
and suggestions.

### Where can I find **Hawk** implementations in other languages?

**Hawk**'s only reference implementation is provided in JavaScript as a node.js package. However, others are actively porting it to other
...
this package is specifically designed for, and a delegated access mode which is being developed separately in
