...
package.exports = exports = configure
...
exports.usage = 'Generates ' + (win ? 'MSVC project files' : 'a Makefile') + ' for the current package'
...
function configure (gyp, argv, callback) {
  ...
  function createConfigFile (err) {
    ...
    // this allows for package-specific configure flags like:
    //
  ...
  function runGyp (err) {
    ...
    argv.push('-Dpackage_root_dir=' + process.cwd())
    argv.push('--depth=.')
