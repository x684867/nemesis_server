...
# Project files generated by this package will use _intermediate_var as a
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  for qualified_target in target_list:
    ...
    # loadable_packages not in a mac_bundle are mapped to
    # com.googlecode.gyp.xcode.bundle, a pseudo-type that xcode.py interprets
    # to create a single-file mh_bundle.
    _types = {
      'executable':             'com.apple.product-type.tool',
      'loadable_package':        'com.googlecode.gyp.xcode.bundle',
      'shared_library':         'com.apple.product-type.library.dynamic',
      'static_library':         'com.apple.product-type.library.static',
      'executable+bundle':      'com.apple.product-type.application',
      'loadable_package+bundle': 'com.apple.product-type.bundle',
