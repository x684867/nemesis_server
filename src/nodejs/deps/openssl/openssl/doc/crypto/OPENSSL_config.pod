...
or the more sophisticated functions such as CONF_packages_load() during
...
functions such as CONF_load_packages() directly.
...
L<conf(5)|conf(5)>, L<CONF_load_packages_file(3)|CONF_load_packages_file(3)>,
L<CONF_packages_free(3),CONF_packages_free(3)>
