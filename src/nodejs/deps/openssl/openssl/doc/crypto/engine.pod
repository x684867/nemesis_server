...
engine - ENGINE cryptographic package support
...
These functions create, manipulate, and use cryptographic packages in the
...
programmer wishes to make alternative ENGINE packages available to the
