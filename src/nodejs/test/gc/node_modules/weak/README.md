...
That's where `node-weak` comes in! This package exports V8's `Persistent<Object>`
...
This package can, for example, be used for debugging; to determine whether or not
